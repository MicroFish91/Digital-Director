...
function timeConfig(timeFormat){
    ...
    var timeTwo = new Date(Date.UTC(parseInt(timeFormat.slice(7, 11)), mm, parseInt(timeFormat.slice(4, 6)) + 1, parseInt(timeFormat.slice(12, 14)), parseInt(timeFormat.slice(15, 17)) + 10, 0));
