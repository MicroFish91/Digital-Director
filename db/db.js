...
db.student.create({firstName: 'Jenny', lastName: 'Doe', phoneNumber: '5419900760', email: 'tracy@gmail.com', parentname1: 'John Smith', parentPhoneNumber: '8322917066', parentEmail: 'coolGuy2013@gmail.com', address: '1234 Westheimer Pkwy', uniformSize: 'm', instrument: 'tuba'});
db.student.create({firstName: 'Paula', lastName: 'Doe', phoneNumber: '5419900760', email: 'tracy@gmail.com', address: '1234 Westheimer Pkwy', uniformSize: 'm', instrument: 'tuba'});
